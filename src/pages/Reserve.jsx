    ...
    >
      ...
      <div className="relative z-10 w-full px-8 md:px-20 lg:px-32 grid lg:grid-cols-2 gap-16 items-center py-24">
        ...
        <div className="reserve-left">
          <p className="text-red-500 uppercase tracking-[0.45em] text-sm">
            Reservation
          </p>

          <h1 className="mt-6 text-white font-special font-bold text-4xl md:text-6xl leading-[0.9]">
            Your Table Awaits
          </h1>

          <p className="mt-8 max-w-xl text-gray-200 text-lg leading-relaxed font-body">
          ...
          <div className="mt-12 flex gap-10">
            <div>
              <h3 className="text-red-500 text-3xl font-special">01</h3>
              <p className="text-gray-300 text-sm font-body">Choose Date</p>
            </div>
            <div>
              <h3 className="text-red-500 text-3xl font-special">02</h3>
              <p className="text-gray-300 text-sm font-body">Select Guests</p>
            </div>
            <div>
              <h3 className="text-red-500 text-3xl font-special">03</h3>
              <p className="text-gray-300 text-sm font-body">Confirm</p>
            </div>
          </div>
        </div>
        ...
        >
          {status === "confirmed" ? (
            <div className="flex flex-col items-center text-center py-10">
              ...
              <h2 className="text-3xl font-special text-gray-900">
                Table Reserved
              </h2>
              ...
              <Button
                ...
                className="mt-8 text-xl font-special text-gray-500 underline underline-offset-4 hover:text-red-500 transition-colors"
              >
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className={`mt-2 w-full p-4 rounded-xl bg-gray-100 outline-none ring-1 ring-transparent transition-shadow focus:ring-2 focus:ring-red-500 ${
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex items-center justify-between p-2 rounded-xl bg-gray-100">
                      <button
                        ...
                        className="w-9 h-9 flex items-center justify-center rounded-lg bg-white text-gray-700 shadow-sm transition-all hover:bg-red-500 hover:text-white disabled:opacity-30 disabled:hover:bg-white disabled:hover:text-gray-700 active:scale-90"
                      >
                        <Minus size={16} />
                      </button>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`mt-2 w-full p-4 rounded-xl bg-gray-100 outline-none ring-1 ring-transparent transition-shadow focus:ring-2 focus:ring-red-400 ${
                ...
                <div>
                  <input
                    ...
                    className={`w-full p-4 rounded-xl bg-gray-100 outline-none ring-1 ring-transparent transition-shadow focus:ring-2 focus:ring-red-500 ${
                ...
                <Button
                  ...
                  className="w-full py-4 rounded-xl font-body transition-colors  "
                >
                  Find A Table
                </Button>
